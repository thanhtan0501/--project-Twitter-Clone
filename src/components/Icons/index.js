...
export const ExploreIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const BookmarksActiveIcon = ({
    width = "2rem",
    height = "2rem",
    className,
}) => (
...
export const ListsIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PinnedIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const NewListIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const DetailIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PollIcon = ({ width = "2rem", height = "2rem", className }) => (
    <svg
        className={className}
        width={width}
        height={height}
